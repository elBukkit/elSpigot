...
class CraftMetaSkull extends CraftMetaItem implements SkullMeta {
    ...
    CraftMetaSkull(Map<String, Object> map) {
        ...
        Object owner = map.get(SKULL_OWNER.BUKKIT);
    ...
    Builder<String, Object> serialize(Builder<String, Object> builder) {
        ...
        if (hasOwner()) {
            NBTTagCompound nbtData = new NBTTagCompound();
            NBTTagCompound profileData = nbtData.getCompound(SKULL_OWNER.BUKKIT);
            nbtData.set(SKULL_OWNER.BUKKIT, profileData);
            GameProfileSerializer.serialize(profileData, profile);
            CraftMetaItemData data = CraftMetaItemData.getData(nbtData);
            return data.serialize(builder);
        }
        return builder;
    }
}
